...
export class RemoveExpenseTagCommandHandler extends FormCommandHandler<ExpenseTagForm, IListExpenseTagsRouteParams, IModifyExpenseTagsRequestBody, IListExpenseTagsViewOptions> {
    ...
    public async executeCommandAsync(form: ExpenseTagForm): Promise<IRequestResult> {
        try {
            ...
            if (form.isValid) {
                ...
                await this._expenseTagsRepository.removeAsync(form.initialName.value!, form.etag!);
            }
