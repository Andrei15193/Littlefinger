...
export abstract class CommandHandler<TRouteParams extends {} = {}, TRequestBody extends IBasePageRequestBody = IBasePageRequestBody, TViewOptions extends IBaseViewOptions = IBaseViewOptions, TQueryParams extends {} = {}> extends RequestHandler<TViewOptions> {
