...
export class GetExpenseQueryHandler extends FormQueryHandler<ExpenseForm, IEditExpenseRouteParams, IExpenseFormViewOptions> {
    ...
    public async executeQueryAsync(form: ExpenseForm, { month: expenseMonth, id: expenseId }: IEditExpenseRouteParams): Promise<IRequestResult> {
        try {
